              ...
              <div className="w-full lg:w-[420px] sticky top-[64px] z-30 space-y-3 bg-[#f8f9fa]">
                ...
                {results && results.length > 0 && (
                  <div className="grid grid-cols-1 gap-3 animate-in fade-in duration-500">
                    <div className="bg-white p-5 border border-gray-200 shadow-sm rounded-sm flex flex-col justify-center relative overflow-hidden">
                      <div className="absolute top-0 left-0 w-1 h-full bg-[#5244e8]"></div>
                      <span className="text-xs font-bold text-slate-400 mb-1">TARGET BLOG</span>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-white p-5 border border-gray-200 shadow-sm rounded-sm flex flex-col justify-center relative overflow-hidden">
                        ...
                        <div className="flex items-end gap-1">
                          <span className="text-xl font-bold text-green-600">{results.filter(r => r.status === "indexed").length}</span>
                      ...
                      <div className="bg-white p-5 border border-gray-200 shadow-sm rounded-sm flex flex-col justify-center relative overflow-hidden">
                        ...
                        <div className="flex items-end gap-1">
                          <span className="text-xl font-bold text-red-500">{results.filter(r => r.status === "missing").length}</span>
                          <span className="text-xs font-medium text-slate-400 mb-1">건</span>
                        </div>
                      </div>
                    </div>
