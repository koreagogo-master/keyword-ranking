    ...
    <div className="bg-gray-50 py-16 px-6">
      <div className="max-w-4xl mx-auto bg-white p-10 md:p-16 rounded-xl shadow-sm border border-gray-100">
        ...
        <div className="prose max-w-none text-sm text-slate-600 leading-loose space-y-6">
          ...
          <p><strong>제 3 조 (포인트 결제 취소 및 환불, 유효기간)</strong><br />
          ...
          4. 환불 요청은 고객센터(이메일 또는 1:1 문의)를 통해 접수해야 하며, 회사는 접수일로부터 3영업일 이내에 결제 취소 처리를 진행합니다.<br />
          5. <strong>포인트 환불 시, 원칙적으로 회원이 결제하셨던 동일한 수단으로 결제 취소 처리됩니다.</strong><br />
          6. <strong>충전된 포인트는 어떠한 경우에도 회원 간 양도가 불가합니다.</strong><br />
          7. <strong>구매한 포인트를 사용 및 취소/환불할 수 있는 기한은 결제일로부터 1년 이내로 제한됩니다.</strong></p>
