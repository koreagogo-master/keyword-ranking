...
function PlaceRankContent() {
  ...
  const handleSave = async () => {
    ...
    if (!user) {
      ...
      setLoginModalSubMessage('로그인 후 설정을 저장할 수 있습니다.');
            ...
            <div className="flex justify-between items-start mb-8">
              ...
              <div className="flex items-center gap-2 mt-1 shrink-0">
                <button
                  ...
                  className={`px-4 py-2 text-sm font-bold text-white rounded-md shadow-sm flex items-center gap-1.5 transition-colors ${(isDirty || !hasSearched) ? 'bg-slate-400 cursor-not-allowed' : 'bg-slate-700 hover:bg-slate-800'
                    }`}
                >
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-sm mx-4 relative">
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col gap-3">
                <button
                  onClick={() => router.push('/login?redirect=/place-rank')}
